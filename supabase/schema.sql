-- ============================================================
-- Basketball Tournament Statistics — Complete Database Schema
-- ============================================================
...
-- ============================================================
-- ROW LEVEL SECURITY (Public Access Enabled for Direct Use)
-- ============================================================
...
CREATE POLICY "tournaments_public_all" ON tournaments FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "games_public_all"       ON games FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "players_public_all"     ON players FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "pgs_public_all"         ON player_game_stats FOR ALL USING (true) WITH CHECK (true);

GRANT EXECUTE ON FUNCTION increment_stat(UUID, TEXT, INTEGER) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION finalize_game(UUID) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION reopen_game(UUID) TO anon, authenticated, service_role;
